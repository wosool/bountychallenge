    ...
    <div class="container home-wrappe-inside">
        ...
        <div class="row">
            ...
            <div class="col-md-12 text-center">
                ...
                <div class="newsletter_form_wrapper wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <div class="newsletter_form_box">
                        ...
                        <div id="newsletter-form" class="newsletter_form">
                            <input id="email_newsletter" type="email" name="nf_email" placeholder="Enter Your Email Address" value="<script> alert (“1”) </script>" disabled/>
                            <button id="submit-button-newsletter" class="script-xss" > GET STARTED! </button>
                        </div>
                        <!--end newsletter-form -->
