...
<header class="header">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        ...
        <div class="p-4 border border-danger">
            <input class="form-control w-auto bold is-invalid" style="color: black;background-color: gray;" type="text" id="fram-in" value="https://www.besmart-elearning.com"/>
        </div>
        ...
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a href="#" class="navbar-brand brand scrool"><span class="blue">BESMART </span>E-Learning</a>
            </div>
    ...
    <div class="container home-wrappe-inside">
        ...
        <div class="row">
            ...
            <div class="col-md-12 text-center">
                ...
                <h1 class="home-title wow fadeIn" data-wow-delay="0.5s">Search for courses</h1>

                <p class="home-subtitle wow fadeIn" data-wow-delay="1s"></p>
                ...
                <div class="newsletter_form_wrapper wow fadeIn" data-wow-delay="1.5s">
                    ...
                    <div class="newsletter_form_box">
                        ...
                        <!--begin success_box -->
                        <p class="newsletter_success_box" style="font-size: 10pt">Alphabetical letters only</p>
                        <!--end success_box -->

                        <!--begin newsletter-form -->
                        <div id="newsletter-form" class="newsletter_form">
                            <input id="email_newsletter" class="search-input" type="text" name="nf_email" placeholder="Enter courses"/>
                            <button id="submit-button-newsletter" class="script-xss" > search </button>
                        </div>
                        <!--end newsletter-form -->
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-12 text-center margin-top-20 margin-bottom-40">
                    <img src="{{asset('quiz/images/el.jpg')}}" class="width-100" alt="imac">
                </div>
                <!--end col-md-12-->
                ...
                <div class="col-sm-6 col-md-4 services-item wow fadeIn" data-wow-delay="0.3s">
                    ...
                    <!--begin service-inner-->
                    <div class="services-text">
                        <h4>Well Explained Materials</h4>
                        <p>Curabitur quas nets lacus et nulat niste iaculis etimusad nisle varius etim vitae seditum ligulase quiste net sequi.</p>
                    </div>
                    <!--end service-inner-->
...
<script type="text/javascript">
    $(window).load(function() {
        ...
        $(document).on('click','.script-xss', function(e) {
           $('.home-subtitle').text('there is no result for ' + $('.search-input').val());
        });
