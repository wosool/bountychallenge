    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        ...
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a href="#" class="navbar-brand brand scrool"><span class="blue">First-</span>Bank</a>
            </div>

            <div id="navbar-collapse-02" class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="javascript:void(0)" class="purchase login-btn">Login</a></li>
                    <li><a href="#">Home</a></li>
...
<script type="text/javascript">
    $(window).load(function() {
        ...
        $(document).on('click','.login-btn', function(e) {
            e.preventDefault();
            alert('500 Internal Server Error server name:CBP00234');
        });
    });
</script>
