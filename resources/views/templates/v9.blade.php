...
<header class="header">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
            ...
            <div class="p-4 border border-danger">
                <input class="form-control w-auto bold is-invalid" style="color: black;background-color: gray;" type="text" id="fram-in" value="https://www.fashion-store.com?cookies=session-sdfhjsadjhf"/>
            </div>
