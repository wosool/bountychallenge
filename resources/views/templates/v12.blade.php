...
<header class="header">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        ...
        <div class="form-inline ">
            <div class="p-4">
                <input class="form-control w-auto" style="width: 70%;color: black;background-color: gray;" type="text" id="fram-in" value="https://www.life-hospital.com?userid=1"/>
        ...
        <div class="container">
            ...
            <div id="navbar-collapse-02" class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="javascript:void(0)" class="purchase login-btn-12">Welcome : Patient 1 </a></li>
                    <li><a href="#">Home</a></li>
...
<script type="text/javascript">
    ...
    $(window).load(function() {
        ...
        $(document).on('click','.go-btn', function(e) {
            var url = $('#fram-in').val();
            var uID = getParameterByName('userid',url);

            if(uID != null){
                //<li><a href="javascript:void(0)" class="purchase login-btn-12">Welcome : Patient 1 </a></li>
                $('.login-btn-12').text('Welcome : Patient ' + uID);
            }
        });
