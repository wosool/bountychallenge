        ...
        <div class="container">
            ...
            <div id="navbar-collapse-02" class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    <li><a data-toggle="modal" data-target="#login-model" href="javascript:void(0)" class="purchase">Login</a></li>
                    <li><a href="#">Home</a></li>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary do-login">Login</button>
                </div>
            </div>
        </div>
    </div>
        ...
        $(document).on('click','.do-login', function(e) {
            ...
            if(user.length == 0 || pass.length == 0){
                ...
                if(user.toLowerCase() == 'admin' && pass.toLowerCase() == 'admin'){
                    alert('welcome admin you are login');
                    $('.do-login').text('Welcome admin');
