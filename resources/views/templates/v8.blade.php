...
<div id="list-div">
    <h1>Index of /dist</h1>
    <pre>
        <img src="{{asset('quiz/images/blank.gif')}}" alt="Icon ">
        <a href="#">Name</a>
        <a href="#">Last modified</a>
        <a href="#">Size</a>
        <a href="#">Description</a>
        <hr>
        <img src="{{asset('quiz/images/back.gif')}}" alt=""><a href="#">Parent Directory</a>                             -
        <img src="{{asset('quiz/images/folder.gif')}}" alt="[DIR]"><a href="#" class="home-list">/HOME</a>                   2022-06-17 12:55    -
        <img src="{{asset('quiz/images/folder.gif')}}" alt="[DIR]"><a href="#">/TEST</a>                   2022-06-17 12:55    -
    <hr>
    </pre>
    ...
    <header class="header">
        ...
        <nav class="navbar navbar-default navbar-fixed-top">
            ...
            <div class="form-inline ">
                <div class="p-4">
                    <input class="form-control w-auto bold" style="width: 70%;color: black;background-color: gray;" type="text" id="fram-in" value="https://www.fashion-store.com/home"/>
                    <button class="go-btn btn btn-warning">
                        Go >
                    </button>
                </div>
            </div>
