        ...
        <div class="container">
            ...
            <div id="navbar-collapse-02" class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="javascript:void(0)" class="purchase">Welcome User</a></li>
                    <li><a href="#">Home</a></li>
...
<div class="text-center" style="margin: 150px">
    <p class="text-danger bold" style="margin-top: 50px">Note : shared with everyone</p>
    <img src="{{asset('quiz/images/report2.png')}}" alt="">
