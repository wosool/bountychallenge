        ...
        <div class="container">
            ...
            <div id="navbar-collapse-02" class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="javascript:void(0)" class="purchase flight-btn">show available flight</a></li>
                    <li><a href="#">Home</a></li>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-12 text-center margin-top-20 margin-bottom-40">
                    <h2 class="section-title">Available Flight</h2>
                    <p class="flight-btn-err text-danger bold" style=""></p>
...
<script type="text/javascript">
    $(window).load(function() {
        ...
        $(document).on('click','.flight-btn', function(e) {
           $('.flight-btn-err').text('This current version is not supported anymore');
        });
